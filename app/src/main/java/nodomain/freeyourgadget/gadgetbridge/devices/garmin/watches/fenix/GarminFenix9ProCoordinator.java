...
public class GarminFenix9ProCoordinator extends GarminFenix9Coordinator {
    @Override
    ...
    protected Pattern getSupportedDeviceName() {
        ...
        return Pattern.compile("^fenix 9 pro$");
    }

    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_garmin_fenix_9_pro;
    }
}