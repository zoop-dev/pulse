...
public class IGPSportWorkoutParser implements ActivitySummaryParser {
    private static final Logger LOG = LoggerFactory.getLogger(IGPSportWorkoutParser.class);
    ...
    public IGPSportWorkoutParser(final Context context) {
