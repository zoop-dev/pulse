...
public class GarminFenix6SportCoordinator extends GarminWatchCoordinator {
    @Override
    ...
    protected Pattern getSupportedDeviceName() {
        ...
        return Pattern.compile("^fenix 6 Sport$");
    }

    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_garmin_fenix_6_sport;
    }
}
