...
public class GarminForerunner225Coordinator extends GarminWatchCoordinator {
    @Override
    ...
    protected Pattern getSupportedDeviceName() {
        ...
        return Pattern.compile("^Forerunner 225$");
    }

    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_garmin_forerunner_225;
    }

    @Override
    public boolean supportsVO2Max(@NonNull final GBDevice device) {
        // Its optical sensor of that era could not reliably gather HRV, which VO2 Max relies on
        return false;
    }
    ...
    @Override
    public boolean supportsPaiTime(@NonNull final GBDevice device) {
        return false;
    }
